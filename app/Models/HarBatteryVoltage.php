 ...
 * @property array<int, array<string, mixed>> $cells_24v
 * @property array<string, mixed>|null $summary_24v
 * @property array<int, array<string, mixed>> $cells_110v
 * @property array<string, mixed>|null $summary_110v
 * @property array<int, array<string, mixed>> $charging_conditions
 ...
 */
class HarBatteryVoltage extends Model
{
    use HasFactory;
    ...
    protected function casts(): array
    {
        return [
            ...
            'manager_ul_id' => 'integer',
            'tl_har_id' => 'integer',
            'staff_har_id' => 'integer',
    ...
    /**
     * Scope query to a given machine.
     *
     * @param  Builder<$this>  $query
     * @return Builder<$this>
     */
