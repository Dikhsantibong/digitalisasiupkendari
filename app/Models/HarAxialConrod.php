 ...
 * @property string $torque_standard
 * @property array<int, array<string, mixed>> $measurements
 ...
 */
class HarAxialConrod extends Model
{
    use HasFactory;
     ...
     */
    public function scopeForUnit(Builder $query, Unit|int $unit): void
    {
