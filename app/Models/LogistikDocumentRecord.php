...
use Database\Factories\LogistikDocumentRecordFactory;
...
/**
 * A saved, editable Laporan Logistik & Gudang (rich text or
...
class LogistikDocumentRecord extends Model
{
    /** @use HasFactory<LogistikDocumentRecordFactory> */
