...
/**
 * Jadwal Patrol Check Harian K3L & Lingkungan per unit, bulan, dan tahun.
...
class K3PatrolCheckJadwal extends Model
{
    use BelongsToUnit, HasFactory;

    protected $table = 'k3_patrol_check_jadwals';
