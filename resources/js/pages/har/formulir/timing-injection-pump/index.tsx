...
export default function TimingInjectionPumpIndex({
    ...
    const [checklistItems, setChecklistItems] = useState<TimingChecklistItem[]>(
        () => {
...
setInstalledPower(m.capacity_kw);
    ...
    return (
        <>
            <Head
                title={`Formulir Checklist Timing Injection Pump - ${unit.name}`}
            />
                    ...
                    <div className="w-full shrink-0 space-y-5 lg:w-[380px] xl:w-[420px]">
                        ...
                        <div className="space-y-4 rounded-lg border border-border bg-card p-4">
                            <div className="border-b border-border pb-2">
                                ...
                                <p className="text-[12px] text-muted-foreground">
                                    Struktur hierarki: Manager UL (Kiri), TL Har
                        ...
                        <div className="flex flex-1 flex-col justify-between rounded-lg border border-border bg-card shadow-sm">
                            ...
                            <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border p-4">
                                <div>
                                    ...
                                    <p className="text-[12px] text-muted-foreground">
                                        Kop surat, tanggal, spesifikasi, dan
                                        tanda tangan otomatis disesuaikan pada
                                        PDF.
                                    </p>
                                </div>
                                ...
                                <div className="space-y-4 p-4">
                                    ...
                                    <div className="flex flex-wrap items-center justify-between gap-3 rounded-md border border-border bg-muted/20 p-2.5 text-xs">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div className="flex items-center gap-1">
                                                ...
                                                <span className="mr-0.5 ml-1.5 text-[11px] text-muted-foreground">
                                                    Kustom:
                                                </span>
                                                <Input
                                                    type="number"
                                                    ...
                                                    className="h-7 w-14 text-center font-mono text-xs font-medium"
                                                />
                                            </div>
                                        </div>
                                    ...
                                    {compact ? (
                                        <MobileRowEditor
                                            ...
                                            subtitle={(item) =>
                                                `Sebelum ${item.timing_before || '–'} · Sesudah ${item.timing_after || '–'}`
                                            }
                                            ...
                                            <table className="w-full min-w-[700px] border-collapse text-xs">
                                                <thead>
                                                    <tr className="border-b border-border bg-muted/40 text-center font-semibold">
                                                        <th
                                                            rowSpan={2}
                                                            className="w-14 border-r border-border p-2"
                                                        >
                                                            CYL.
                                                        </th>
                                                        <th
                                                            colSpan={2}
                                                            className="border-r border-border p-2 tracking-wider"
                                                        >
                                                            TIMING PEMBAKARAN
                                                        </th>
                                                        <th
                                                    ...
                                                    <tr className="border-b border-border bg-muted/20 text-center text-[11px] font-semibold">
                                                        <th className="w-32 border-r border-border p-1.5">
                                                            SEBELUM
                                                        </th>
                                                        <th className="w-32 border-r border-border p-1.5">
                                                            SESUDAH
                                                ...
                                                <tbody className="divide-y divide-border">
                                                    {checklistItems.map(
                                                        (item) => (
                                                            ...
                                                            >
                                                                <td className="border-r border-border bg-muted/5 p-2 text-center text-sm font-bold">
                                                                    {
                                                                        item.cylinder
                                                                    }
                                                                </td>
                                                                <td className="border-r border-border p-1.5 text-center">
            ...
            <Dialog open={showHistory} onOpenChange={setShowHistory}>
                <DialogContent className="max-w-xl">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Daftar formulir yang pernah disimpan untuk unit{' '}
                            {unit.name}.
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    <div className="mt-2 max-h-96 space-y-2 overflow-y-auto">
                        {history.length === 0 ? (
                            <div className="rounded-md border border-dashed p-4 text-center text-xs text-muted-foreground">
                                Belum ada riwayat formulir tersimpan untuk unit
                                ini.
                            </div>
                        ) : (
                            history.map((h) => {
                                const m = machines.find(
                                    (mac) => mac.id === h.machine_id,
                                );

                                return (
                                    <div
                                        key={h.id}
                                        className="flex items-center justify-between rounded-md border border-border p-3 text-xs transition-colors hover:bg-muted/30"
                                    >
                                        <div>
...
TimingInjectionPumpIndex.layout = {
    breadcrumbs: [
        ...
        {
            title: 'Checklist Timing Injection Pump',
            href: timingRoutes.index(),
        },
    ],
};
