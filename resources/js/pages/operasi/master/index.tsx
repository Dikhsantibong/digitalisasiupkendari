...
export default function MasterIndex({
    ...
    return (
        <>
            <Head title={`Master Operasi — ${resource.label}`} />
                ...
                <div className="flex flex-wrap gap-2">
                    {resources.map((r) => (
                        <Button
                            ...
                            asChild
                        >
                            <Link href={master.index(r.slug).url}>{r.label}</Link>
                        </Button>
                    ))}
                </div>
                ...
                {resource.unit_scoped && (
                    <div className="flex flex-wrap items-end gap-3 rounded-md border border-border bg-card p-3">
                        <OperasiSelect
                            ...
                            onChange={(value) =>
                                router.get(
                                    master.index(resource.slug).url,
                                        ...
                                        {can_manage && (
                                            <TableCell>
                                                <div className="flex items-center justify-end gap-1">
                                                    ...
                                                    <ConfirmDeleteDialog
                                                        action={MasterController.destroy.form({
...
function MasterForm({
    ...
    const action = editing
        ? MasterController.update.form({ resource: resource.slug, id: editing.id })
        : MasterController.store.form(resource.slug);
