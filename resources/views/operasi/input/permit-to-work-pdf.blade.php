...
<head>
    <meta charset="UTF-8">
    <title>Laporan Permit to Work Pembangkit - {{ $unit->name }} - {{ $monthName }} {{ $year }}</title>
    <style>
        @page {
            size: A4 portrait;
            margin: 8mm;
    ...
    <table class="header-table">
        <tr>
            ...
            <td class="title-box">
                ...
                <h3>LAPORAN PERMIT TO WORK PEMBANGKIT</h3>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th rowspan="2" style="width: 290px;">URAIAN</th>
                <th rowspan="2" style="width: 90px;">TANGGAL</th>
                <th colspan="2">STATUS</th>
            </tr>
            <tr>
                <th style="width: 65px;">OPEN</th>
        ...
        <tbody>
            @foreach($rows as $row)
                <tr>
                    ...
                    <td class="text-center font-bold">{{ $row['open'] }}</td>
                    <td class="text-center font-bold">{{ $row['close'] }}</td>
                </tr>
            @endforeach
