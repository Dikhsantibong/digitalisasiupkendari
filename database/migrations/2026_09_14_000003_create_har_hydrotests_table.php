...
return new class extends Migration
{
    ...
    {
        Schema::create('har_hydrotests', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('unit_id')->constrained()->cascadeOnDelete();
            $table->foreignId('machine_id')->constrained()->cascadeOnDelete();
            $table->date('test_date');
            $table->string('document_number')->default('FMKD-314-10.3.3.a-B11');
            ...
            // Cylinder hydrotest checklist data
            $table->unsignedTinyInteger('cylinders_count')->default(8);
            $table->string('standard_allowed')->nullable()->default('Tidak ada kebocoran');
    ...
    {
        Schema::dropIfExists('har_hydrotests');
    }
};
