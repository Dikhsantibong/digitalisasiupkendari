...
return new class extends Migration
{
    ...
    {
        Schema::create('har_axial_conrods', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('unit_id')->constrained()->cascadeOnDelete();
            $table->foreignId('machine_id')->constrained()->cascadeOnDelete();
            $table->date('test_date');
            $table->string('document_number')->default('FMKD-314-10.3.3.a-B7');
            ...
            $table->string('torque_standard')->default('750 NM');
            ...
            $table->unique(['unit_id', 'machine_id', 'test_date'], 'har_axial_conrods_unique');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('har_axial_conrods');
    }
};
