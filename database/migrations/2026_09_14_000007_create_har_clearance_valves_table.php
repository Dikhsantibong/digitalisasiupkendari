...
return new class extends Migration
{
    ...
    {
        Schema::create('har_clearance_valves', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('unit_id')->constrained()->cascadeOnDelete();
            $table->foreignId('machine_id')->constrained()->cascadeOnDelete();
            $table->date('test_date');
            $table->string('document_number')->default('FMKD-314-10.3.3.a-B3');
            ...
            $table->text('cylinder_notes')->nullable();
            $table->string('standard_ex')->default('0.60 mm');
            $table->string('standard_in')->default('0.30 mm');
            $table->text('standard_allowed')->nullable();
            $table->text('visual_inspection')->nullable();

            // Signatories (Mengetahui, Diperiksa, Dibuat)
            ...
            // PDF layout settings
            $table->unsignedSmallInteger('page_margin_top')->default(10);
            $table->unsignedSmallInteger('page_margin_bottom')->default(10);
            $table->unsignedSmallInteger('page_margin_left')->default(12);
            $table->unsignedSmallInteger('page_margin_right')->default(12);
    ...
    {
        Schema::dropIfExists('har_clearance_valves');
    }
};
