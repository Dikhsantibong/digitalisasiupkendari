...
return new class extends Migration
{
    ...
    {
        Schema::create('har_crankshaft_deflections', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('unit_id')->constrained()->cascadeOnDelete();
            $table->foreignId('machine_id')->constrained()->cascadeOnDelete();
            $table->date('test_date');
            $table->string('document_number')->default('FMKD-314-10.3.3.a-B2');
            ...
            $table->string('standard_min')->default('-0.06');
            $table->string('standard_max')->default('+0.08');
    ...
    {
        Schema::dropIfExists('har_crankshaft_deflections');
    }
};
