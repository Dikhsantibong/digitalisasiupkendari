...
return new class extends Migration
{
    ...
    {
        Schema::create('har_counter_weights', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('unit_id')->constrained()->cascadeOnDelete();
            $table->foreignId('machine_id')->constrained()->cascadeOnDelete();
            $table->date('test_date');
            $table->string('document_number')->default('FMKD-314-10.3.3.a-B8');
            ...
            $table->unique(['unit_id', 'machine_id', 'test_date'], 'har_counter_weights_unique');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('har_counter_weights');
    }
};
