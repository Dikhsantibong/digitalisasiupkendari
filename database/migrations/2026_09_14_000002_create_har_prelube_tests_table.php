...
return new class extends Migration
{
    ...
    {
        Schema::create('har_prelube_tests', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('unit_id')->constrained()->cascadeOnDelete();
            $table->foreignId('machine_id')->constrained()->cascadeOnDelete();
            $table->date('test_date');
            $table->string('document_number')->default('FMKD-314-10.3.3.a-B12');
    ...
    {
        Schema::dropIfExists('har_prelube_tests');
    }
};
