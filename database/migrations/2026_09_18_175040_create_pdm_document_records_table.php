...
/**
 * The saved, editable Laporan PdM & Maturity Level Pembangkit documents (rich
...
return new class extends Migration
{
    ...
    {
        Schema::create('pdm_document_records', function (Blueprint $table): void {
            $table->id();
    ...
    {
        Schema::dropIfExists('pdm_document_records');
    }
};
