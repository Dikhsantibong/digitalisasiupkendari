...
return new class extends Migration
{
    ...
    {
        Schema::create('har_motor_currents', function (Blueprint $table): void {
            $table->id();
            ...
            // Measurement items (JSON array of { no, motor_name, current_r, current_s, current_t, notes })
            $table->json('items');
            ...
            $table->unique(['unit_id', 'machine_id', 'test_date'], 'har_motor_currents_unique');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('har_motor_currents');
    }
};
