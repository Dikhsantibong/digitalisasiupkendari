...
class OrganizationSeeder extends Seeder
{
    ...
    /**
     * Standard roster per generating unit (defined in EmployeeSeeder).
     */
    public const UNIT_ROSTER = EmployeeSeeder::UNIT_ROSTER;
    ...
    /**
     * Seeds master employees for each unit and service unit via EmployeeSeeder.
     */
